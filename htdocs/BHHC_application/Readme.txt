...
I extended this page from my site as if it were running on Laravel's MVC architecture. The main view is built in show.blade.php. The model and controller are both labeled as such, Application.php and ApplicationController.php. A calculator is also included to show usage of the Factory Method in the creation of a complex mortgage amortization table. For a demo of the page, simply load up the page as http://localhost/{location-of-file}/show.blade.php
